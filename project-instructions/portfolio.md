...
<table style="width: 80%; border-collapse: collapse; margin-top: 15px; margin-left: auto; margin-right: auto; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  <tr>
    <th style="text-align: left; padding: 10px; background-color: #444; color: white; border-bottom: 1px solid #666;">
      💡 What’s the Purpose of <code style="color: #79c0ff;">&lt;nav&gt;</code> and <code style="color: #79c0ff;">&lt;main&gt;</code>?
    </th>
  </tr>
  <tr>
    <td style="padding: 10px; color: #ccc;">
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #ccc;">
      A navigation menu makes it easy for visitors to move between different parts of your site. It’s also a great way to learn how to link pages together using anchor tags (<code style="color: #79c0ff;">&lt;a&gt;</code>).
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;">
      <strong><code style="color: #79c0ff;">git add</code></strong>: Stages (or prepares) your changes, telling Git which files you want to track.  
      <br><br>
      <strong><code style="color: #79c0ff;">git commit</code></strong>: Saves a snapshot of the changes you’ve staged. It’s like taking a picture of your work at a specific moment in time.<br><ul><li>The message added to the <code style="color: #79c0ff;">git commit</code> command should always be customized to describe the work you've completed.</li></ul>
      <br>
      <strong><code style="color: #79c0ff;">git push</code></strong>: Sends your committed changes to the remote repository (e.g., GitHub) so others can see or use your work.
    </td>
  </tr>
</table>

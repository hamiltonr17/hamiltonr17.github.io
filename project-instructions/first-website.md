...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #ccc;">
      Right now, the <code>&lt;main&gt;</code>, <code>&lt;div class="sidebar"&gt;</code>, and <code>&lt;div class="content"&gt;</code> elements are empty containers with nothing inside them. HTML elements without content or styling are invisible on the page. That's totally normal — you'll bring them to life with CSS in the next phase!
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  <tr>
    <th style="text-align: left; padding: 10px; background-color: #444; color: white; border-bottom: 1px solid #666;">
      💡 What is a <code>&lt;link&gt;</code> tag?
    </th>
  </tr>
  <tr>
    <td style="padding: 10px; color: #ccc;">
      The <code>&lt;link&gt;</code> tag tells your HTML page where to find its stylesheet. The <code>rel="stylesheet"</code> attribute says "this is a CSS file," and the <code>href="style.css"</code> attribute says "here's where to find it." Without this link, your browser won't know your CSS file exists!
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #ccc;">
      Right now your name and title are using the browser's <strong>default styling</strong> — basic text with default sizing and spacing. That's because you haven't added any CSS rules for <code>&lt;h2&gt;</code> or <code>&lt;p&gt;</code> yet. You'll fix that in the next phase!
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  <tr>
    <th style="text-align: left; padding: 10px; background-color: #444; color: white; border-bottom: 1px solid #666;">
      💡 What does <code>.content p</code> mean?
    </th>
  </tr>
  <tr>
    <td style="padding: 10px; color: #ccc;">
      The selector <code>.content p</code> targets only <code>&lt;p&gt;</code> elements that are <strong>inside</strong> an element with <code>class="content"</code>. This way, you can style the paragraph in your content area without accidentally changing paragraphs in other parts of your page.
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #ccc;">
      <code>list-style: none</code> removes the default bullet points. <code>border-radius: 100px</code> turns each item into a pill shape. <code>flex-wrap: wrap</code> lets the pills flow onto multiple lines. The <code>transition</code> property makes the hover effect smooth instead of snapping — and <code>:hover</code> tells the browser what to do when the mouse is over each item!
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  <tr>
    <th style="text-align: left; padding: 10px; background-color: #444; color: white; border-bottom: 1px solid #666;">
      💡 What Does <code>filter</code> Do?
    </th>
  </tr>
  <tr>
    <td style="padding: 10px; color: #ccc;">
      The <code>filter</code> property applies visual effects to an element — like Instagram filters but in CSS! <code>grayscale(100%)</code> turns the image fully black and white. On hover, <code>grayscale(0%)</code> reveals the full color — try it! <code>border-radius: 16px</code> rounds the corners and <code>box-shadow</code> adds a soft drop shadow. The hover also lifts the image up with <code>translateY(-4px)</code>. One block of CSS, huge visual impact!
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #ccc;">
      A navigation menu helps visitors move between pages on your site. Almost every website on the internet has one! The <code>&lt;a&gt;</code> (anchor) tags create clickable links that take visitors to different pages.
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #ccc;">
      <code>text-transform: uppercase</code> makes the site title ALL CAPS without changing your HTML. <code>letter-spacing: 0.2em</code> spreads the letters apart for a clean look. <code>border-radius: 12px</code> rounds the nav bar corners and <code>border-radius: 8px</code> rounds the link buttons. On hover, the links flip to a black background with white text — try it! The small title vs. big headline below creates the kind of contrast you see on real studio websites.
    </td>
  </tr>
</table>

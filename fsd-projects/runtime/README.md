...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;">
      <strong>Instances</strong>: Each background element (like a building or lamp) is represented as an object inside its <code style="color: #79c0ff;">instances</code> array. Adding more instances increases visual variety.<br><br>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;">
      <strong>Parallax Movement</strong>: By giving different background objects different <code style="color: #79c0ff;">speedX</code> values, you create a parallax effect where some layers move slower (farther away) and others move faster (closer to the camera).<br><br>
      <strong>Level Speed</strong>: Adding each instance's <code style="color: #79c0ff;">speedX</code> to <code style="color: #79c0ff;">currentLevel.speed</code> lets you increase all scenery movement based on how fast the level is currently scrolling.<br><br>
      <strong>Wrap-Around Logic</strong>: Checking when an object has moved fully off the screen (for example, when <code style="color: #79c0ff;">x + width &lt; 0</code>) and then moving it to the right side creates a continuous, looping background.
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;">
      <strong>Level Data</strong>: The <code style="color: #79c0ff;">currentLevel.gameObjects</code> array contains every object that should appear in the level (players, enemies, platforms, scenery, etc.). Each entry is a data object describing what to create.<br><br>
      <strong>Array Iteration</strong>: A loop lets you visit each item in <code style="color: #79c0ff;">gameObjects</code> and apply the same action to all of them.<br><br>
      <strong>Debug Logging</strong>: Printing <code style="color: #79c0ff;">currentObject.type</code> and <code style="color: #79c0ff;">currentObject.kind</code> helps verify that no objects are being skipped during level generation.
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;">
      <strong>Factory Pattern</strong>: The <code style="color: #79c0ff;">create</code> function decides which specialized builder function should handle each object.<br><br>
      <strong>Conditional Statements</strong>: Using <code style="color: #79c0ff;">if</code> or <code style="color: #79c0ff;">else if</code> statements lets you run different code depending on what <code style="color: #79c0ff;">type</code> the object has.
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;">
      ...
      <strong>Type Matching</strong>: Many game engines use a <code style="color: #79c0ff;">type</code> property to categorize objects (enemies, platforms, goals, etc.). Filtering by type lets you work with specific groups easily.
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;">
      ...
      <strong>Level Scrolling</strong>: Subtracting <code style="color: #79c0ff;">currentLevel.speed</code> pulls all objects left, creating the effect that the player is moving through the world.<br><br>
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">width</code></td>
    <td style="padding: 10px; color: #e2e2e2;">How wide the object is in the game world.</td>
  </tr>
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">height</code></td>
    <td style="padding: 10px; color: #e2e2e2;">How tall the object is in the game world.</td>
  </tr>
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">hitWidth</code></td>
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">hitHeight</code></td>
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">speedX</code></td>
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">speedY</code></td>
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">minY</code></td>
    <td style="padding: 10px; color: #e2e2e2;">The minimum <code style="color: #79c0ff;">y</code> position for objects that move up and down. The object should not move above this value.</td>
  </tr>
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">maxY</code></td>
    <td style="padding: 10px; color: #e2e2e2;">The maximum <code style="color: #79c0ff;">y</code> position for objects that move up and down. The object should not move below this value.</td>
  </tr>
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">contactHealthChange</code></td>
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">contactScoreChange</code></td>
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">projectileHealthChange</code></td>
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">projectileScoreChange</code></td>
    <td style="padding: 10px; color: #e2e2e2;">How the player's score changes when the object is destroyed by a projectile.</td>
  </tr>
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">hp</code></td>
    <td style="padding: 10px; color: #e2e2e2;">The object's health. <code style="color: #79c0ff;">0</code> means projectiles pass through without affecting it; a positive number means it can be destroyed after that many hits; <code style="color: #79c0ff;">Infinity</code> can be used for indestructible objects.</td>
  </tr>
  <tr>
    <td style="padding: 10px; color: #e2e2e2;"><code style="color: #79c0ff;">collect</code></td>
    <td style="padding: 10px; color: #e2e2e2;">Controls whether the object disappears when Hallebot collides with it. <code style="color: #79c0ff;">true</code> means it is collected/removed; <code style="color: #79c0ff;">false</code> means it stays in the world.</td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;">
      <strong>Nested Loops</strong>: Using a loop inside another loop lets you compare every projectile to every game object. The outer loop uses <code style="color: #79c0ff;">i</code>, the inner loop uses <code style="color: #79c0ff;">j</code>.<br><br>
      <strong>Collision Detection</strong>: The helper function <code style="color: #79c0ff;">isCollidingWithProjectile(projectile, object)</code> checks whether a projectile is overlapping a game object, based on their positions and sizes.<br><br>
      <strong>Collision Handling</strong>: Once a collision is found, calling <code style="color: #79c0ff;">handleProjectileObjectCollision(i, j)</code> applies the result (such as reducing <code style="color: #79c0ff;">hp</code>, updating score, or removing the object/projectile).<br><br>
    </td>
  </tr>
</table>
...
- When you run the game:
  ...
  - Objects with positive <code style="color: #79c0ff;">hp</code> are damaged and can be destroyed by projectiles.
  - Objects with <code style="color: #79c0ff;">hp = 0</code> are unaffected and let projectiles pass through.
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;">
      ...
      <strong>Separate Conditionals</strong>: We use two <code style="color: #79c0ff;">if</code> statements to check multiple conditions. There are other ways to do this, but we haven’t introduced them yet.<br><br>
    </td>
  </tr>
</table>
...
<table style="width: 80%; margin-left: auto; margin-right: auto; border-collapse: collapse; margin-top: 15px; background-color: #2c2c2c; border: 1px solid #444; border-radius: 8px; overflow: hidden;">
  ...
  <tr>
    <td style="padding: 10px; color: #e2e2e2;">
      <strong>Level Indexing</strong>: <code style="color: #79c0ff;">currentLevelIndex</code> keeps track of which level the player is currently on. Increasing it points to the next level.<br><br>
      <strong>Level Data</strong>: Each level’s layout and settings come from the <code style="color: #79c0ff;">levels</code> array. Updating <code style="color: #79c0ff;">currentLevel</code> swaps in the new configuration.<br><br>
      <strong>Resetting State</strong>: Clearing <code style="color: #79c0ff;">gameObjects</code> ensures old objects don’t carry over into the next level.<br><br>
      <strong>Win Condition</strong>: If the player moves past the last level in the list, <code style="color: #79c0ff;">player.winConditionMet</code> is set to <code style="color: #79c0ff;">true</code> to indicate victory.
    </td>
  </tr>
</table>
